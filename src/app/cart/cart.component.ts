...
ssd(){
  this.ssdprice1 = Number(this.ssdprice);

  this.ssdp = Number(this.ssdprice)*Number(this.qc);
  this.ssdn = String(this.ssdname);
  this.gt = Number(this.ssdp)+Number(this.gt);

  return this.ssdprice1;
  return this.ssdp;
  return this.ssdn;
  return this.gt;
